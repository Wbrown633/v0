...
class TestJSONScreenFactory():
    ...
    def protocol_factory_make_20v0(self) -> List[JSONScreenBuilder]:
        ...
        flush_2 = JSONScreenBuilder("flush_2").add_type(ScreenType.MachineActionScreen).add_header("PBS rinse").add_description("Rinsing the chip.").add_actions([Pump("waste", 1.05, 50, 120)]).add_completion_msg("PBS rinse complete")
        ...
        flush_3 = JSONScreenBuilder("flush_3").add_type(ScreenType.MachineActionScreen).add_header("Sample pull").add_description("Pulling sample thru chip.").add_actions([Pump("waste", 1.2, 10, 120)]).add_completion_msg("Sample pull completed")
        ...
        wash_1 = JSONScreenBuilder("wash_1").add_type(ScreenType.MachineActionScreen).add_header("PBS Wash 1").add_description("Washing the chip.").add_actions([Pump("waste", 0.2, 10, 120)]).add_completion_msg("Wash 1 complete")
        ...
        flush_5 = JSONScreenBuilder("flush_5").add_type(ScreenType.MachineActionScreen).add_header("PBS Wash 2").add_description("Washing the chip.").add_actions([Pump("waste", 0.4, 10, 120)]).add_completion_msg("Wash 2 complete")

        flush_6 = JSONScreenBuilder("flush_6").add_type(ScreenType.MachineActionScreen).add_header("PBS Wash 2 Part 2").add_description("Washing the chip.").add_actions([Pump("waste", 0.4, 50, 120)]).add_completion_msg("Wash 2 complete")
        ...
        flush_7 = JSONScreenBuilder("flush_7").add_type(ScreenType.MachineActionScreen).add_header("PBS Wash 3").add_description("Washing the chip.").add_actions([Pump("waste", 1.2, 50, 120)]).add_completion_msg("Wash 3 complete")
        ...
        extract_1 = JSONScreenBuilder("extract_1").add_type(ScreenType.MachineActionScreen).add_header("Qiazol 1").add_description("Pulling Qiazol into chip.").add_actions([Pump("waste", 0.5, 10, 0)]).add_completion_msg("Qiazol pull to waste complete")

        extract_2 = JSONScreenBuilder("extract_2").add_type(ScreenType.MachineActionScreen).add_header("Qiazol 2").add_description("Pulling Qiazol into chip.").add_actions([Pump("lysate", 0.2, 10, 0), Release("waste", 1.5, -50, 0)]).add_completion_msg("Qiazol pull and incubation complete")
        ...
        chase_1 = JSONScreenBuilder("chase_1").add_type(ScreenType.MachineActionScreen).add_header("PBS Chase").add_description("Extracting lysate from chip.").add_actions([Pump("lysate", 0.7, 15, 120)])
